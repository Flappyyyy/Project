...
const ClientProgressTable = ({ clients, onSelectClient }) => {
    return (
        <div className="bg-white rounded-xl shadow-sm border border-pink-200 overflow-hidden">
            <div className="p-6 border-b border-pink-200 flex justify-between items-center bg-white">
                <div>
                    <h2 className="text-lg font-bold text-rose-800">Client Progress Overview</h2>
                    <p className="text-sm text-pink-500 mt-1">Overview of active plans and remaining target months.</p>
                </div>
            </div>
